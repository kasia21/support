...
# vxWorks has pthread and other issues
echo 'WITH_GRAPHICSMAGICK = NO' >> CONFIG_SITE.local.linux-x86_64
echo 'WITH_BLOSC = NO' >> CONFIG_SITE.local.linux-x86_64
echo 'WITH_BITSHUFFLE = NO' >> CONFIG_SITE.local.linux-x86_64
echo 'WITH_GRAPHICSMAGICK = NO' >> CONFIG_SITE.local.linux-x86_64.linux-x86_64
echo 'WITH_BLOSC = NO' >> CONFIG_SITE.local.linux-x86_64.linux-x86_64
echo 'WITH_BITSHUFFLE = NO' >> CONFIG_SITE.local.linux-x86_64.linux-x86_64
...
rm galil-3-6/config/GALILRELEASE
touch galil-3-6/config/GALILRELEASE
echo "EPICS_BASE=$EPICS_BASE" >> ./galil-3-6/config/GALILRELEASE
echo "ASYN=$SUPPORT/asyn-$ASYN" >> ./galil-3-6/config/GALILRELEASE
echo "AUTOSAVE=$SUPPORT/autosave-$AUTOSAVE" >> ./galil-3-6/config/GALILRELEASE
echo "SNCSEQ=$SUPPORT/seq-${SNCSEQ//./-}" >> ./galil-3-6/config/GALILRELEASE
echo "SSCAN=$SUPPORT/sscan-$SSCAN" >> ./galil-3-6/config/GALILRELEASE
echo "CALC=$SUPPORT/calc-$CALC" >> ./galil-3-6/config/GALILRELEASE
echo "BUSY=$SUPPORT/busy-$BUSY" >> ./galil-3-6/config/GALILRELEASE
echo "MOTOR=$SUPPORT/motor-$MOTOR" >> ./galil-3-6/config/GALILRELEASE
echo "IPAC=$SUPPORT/ipac-${IPAC//./-}" >> ./galil-3-6/config/GALILRELEASE
echo "GALIL=$SUPPORT/galil-3-6" >> ./galil-3-6/configure/GALILRELEASE
